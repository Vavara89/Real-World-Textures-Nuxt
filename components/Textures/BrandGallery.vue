<template>
  <div class="textgallery">
    <ul class="textures">
      <li v-for="(brand, index) in brands" :key="'brand-' + index" class="texture brands">

        <nuxt-link :to="brand.absoluteUrl">
          <div class="texture__block">
            <div class="texture__image brands noscale">
