  ...
  <div>
    ...
    <div v-if="success" class="modal">
      <div class="inner">
        ...
        <p class="style">You can login with new password</p>
        <nuxt-link class="style green" :to="'/login'">Go to login</nuxt-link>
      </div>
    </div>
    ...
    <div v-if="!success" class="modal">
      <div class="inner">
        ...
        <form @submit="recovery" method="post" class="email">
          ...
          <button :disabled="isSubmitted" :class="[isSubmitted ? 'loading' : '']" type="submit" class="email">confirm</button>

        </form>
        <nuxt-link class="style green" :to="'/login'">Back to login</nuxt-link>
        or
        <nuxt-link class="style" :to="'/recovery'">Send token again</nuxt-link>
      </div>
